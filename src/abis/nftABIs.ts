const nftABIs = [
  {
    "abi": [
      ...
      },
      {
        ...
        "name": "getReservedPresaleQuantity",
        "outputs": [
          {
            "internalType": "uint256",
            "name": "",
